...
//   const currentTemperatur = getMarsTemperature();
//   setTimeout(() => console.log(`Mars temperature is: ${currentTemperatur} degree Celsius`), messageDelay());
// }
...
//    setTimeout(() => onSuccess(actualTemperature), messageDelay);
// }
...
sendMarsTemperature(greet, handleError);s